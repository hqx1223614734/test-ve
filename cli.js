...
module.exports = function(api) {
  api.registerPluginInfo({
    name: 've-cli-hqx-test', // 展示名称
    pkgName: 've-cli-hqx-test', // npm包名
    description: '测试', // 展示在名称下方的描述
  ...
  api.registerGenerate(async ({ pluginInfo, projectInfo, push }) => {
    try {
      ...
      // 克隆git项目到本地
      push('process', '正在克隆项目到本地: https://github.com/hqx1223614734/test-ve');
      console.log(chalk.yellow('正在克隆项目到本地: https://github.com/hqx1223614734/test-ve'));
      const repo = 'https://github.com/hqx1223614734/test-ve';
